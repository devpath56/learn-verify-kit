...
3. **Every finding climbs to ≥ L2.** State the **choice AND the alternative the team rejected**, then push to L3 by naming *why* (the constraint or bet behind it). Cut anything that's still a brochure restate.
...
2. **Headline the contrast.** One line: strongest lens, shallowest lens, and the single biggest bet the product is making. The contrast is the insight.
3. **Cap with a short quiz.** End on a final transfer question — never a trailing "want me to…?" question.
